...
//import toniarts.openkeeper.world.creature.steering.*;
//
///**
...
// */
//public class MovableSystem implements Steerable<Vector2>, IGameLogicUpdatable {
//
...
//
//    private static final Logger LOGGER = Logger.getLogger(MovableSystem.class.getName());
//
//    public MovableSystem(EntityData entityData) {
//        exec = new ThreadPoolExecutor(2, 4, 10, TimeUnit.MINUTES, new LinkedBlockingQueue(), (Runnable r) -> new Thread(r, "PathFinding"));
//
...
//                LOGGER.log(Level.SEVERE, "Failed to shutdown the path finding pool!", ex);
//            }
//            exec = null;
//        }
//    }
