...
//        };
    ...
    public static class MiscVariable extends Variable {
        ...
        public enum MiscType implements IValueEnum {
            ...
            CASINO_BIG_WINNER_INCREASED_HAPPINESS_PERSENTAGE(139), // value=100
            DECREASE_ENTRANCE_PERSENTAGE_OF_LAST_SACKED_CREATURE_TYPE(140), // value=33
            INCREASE_ENTRANCE_PERSENTAGE_OF_NEW_CREATURE_TYPES(141), // value=33
            INCREASED_WORK_RATE_PERSENTAGE_OF_PLAYERS_TORTURED_CREATURE_TYPES(142), // value=25
            INCREASED_WORK_RATE_PERSENTAGE_WHEN_CASINO_BIG_WIN_OCCURS(143), // value=35
            ...
            MODIFY_PLAYER_COLD_WHILE_TRAINING_PER_SECOND(149), // value=-5
