    ...
    public SdtFile(File file) {
        ...
        try (RandomAccessFile rawSdt = new RandomAccessFile(file, "r")) {
            ...
            for (int i = 0; i < files; i++) {
                ...
                entry.setUnknown2(ConversionUtils.readByteAsInteger(rawSdt));
                entry.setType(ConversionUtils.parseEnum(ConversionUtils.readByteAsInteger(rawSdt), SdtFileEntry.SoundType.class));
