 ...
 */
public class ObjectLoader implements ILoader<toniarts.openkeeper.tools.convert.map.Object> {

    @Override
    public Spatial load(AssetManager assetManager, toniarts.openkeeper.tools.convert.map.Object object) {
