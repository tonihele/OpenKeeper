...
public class CustomTabGroupControl extends AbstractController implements TabGroup {
    ...
    public void bind(
      ...
      tabButtonPanel = element.findElementByName("#tab-button-panel");
      contentPanel = element.findElementByName("#tab-content-panel");
      ...
      if (tabButtonPanel == null) {
        ...
        final Element buttonElement = tabButtonPanel.findElementByName("#button-template");
    ...
    public Tab getSelectedTab() {
      ...
      return contentPanel.getElements().get(selectedIndex).getNiftyControl(Tab.class);
    }
    ...
    public int getSelectedTabIndex() {
      ...
      @Override
    public void init(final Properties parameter, Attributes controlDefinitionAttributes) {
    ...
    public int getTabCount() {
      return contentPanel != null ? contentPanel.getElements().size() : 0;
    }
