...
public final class Header {
    ...
    void read_header(Bitstream stream, Crc16[] crcp) throws BitstreamException {
        ...
        do {
            ...
            // If the file has some clutter, (no EOF or frame header after this frame), the frame gets skipped
            // Leave commented now, since the files seem to be ok otherwise, just some *hit at the end
    ...
    public int calculate_framesize() {
        ...
        if (h_layer == 1) {
            ...
            framesize = (144 * bitrates[h_version][h_layer - 1][h_bitrate_index])
                    / frequencies[h_version][h_sample_frequency];
            // This should not be with normal MPEG2 - Toni Helenius
